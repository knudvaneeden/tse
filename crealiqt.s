 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNLineCreateRecordQaTseB )
 // e.g. HELPDEF HELPDEFFNLineCreateRecordQaTseB
 // e.g.  title = "FNLineCreateRecordQaTseB() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 ...
 // e.g. END
 //
 STRING infoS[255] = "Block copied to Microsoft Windows clipboard." // change this
 //
 ...
 //
 // Extract the first top line of the highlighted block
 //
 GotoBlockBegin()
 ...
 IF LFind( "^$", "cgx" )
  BegLine()
  InsertText( "sep", _INSERT_ )
  EndLine()
  ExecMacro( "template" )
  Down()
  PROCMacroRunPurge( "replregf" ) // operation: replace: record: .gf: identifier: unique: check: global: not"
 ENDIF
 //
 PopBlock()
 PopPosition()
