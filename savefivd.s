...
INTEGER PROC FNFileSetUploadGithubFileVersionControlB( STRING yourLocalDirectoryS, STRING githubRemoteDirectoryUrlS, STRING fileNameExecutableGitS, STRING fileNameExecutableTccS, STRING githubUserNameS, STRING githubPasswordS )
 ...
 AddLine( "" )
 AddLine( "REM --- GitHub authentication ---" )
 AddLine( Format( 'set "GITHUB_USER=', githubUserNameS, '"' ) )
 AddLine( Format( 'set "GITHUB_PAT=', githubPasswordS, '"' ) ) // NOTE: githubPasswordS is now expected to be a GitHub PAT (Personal Access Token)
 ...
 AddLine( ")" )
 AddLine( "" )
 AddLine( "REM Build an authenticated push URL without storing the token in the repository config." )
 AddLine( Format( 'set "REMOTE_NOAUTH=%GITHUB_REMOTE%"' ) )
 ...
 AddLine( Format( fileNameExecutableGitS, " ", "rev-parse", " ", "--git-dir", " ", "1>nul", " ", "2>nul" ) )
 AddLine( Format( "if errorlevel 1 ", fileNameExecutableGitS, " ", "init", " ", "." ) )
 AddLine( "" )
 ...
 AddLine( Format( fileNameExecutableGitS, " ", "branch", " ", "-M", " ", "main" ) )
 AddLine( "" )
 AddLine( "REM Configure remote origin." )
 AddLine( Format( fileNameExecutableGitS, " ", "remote", " ", "get-url", " ", "origin", " ", "1>nul", " ", "2>nul" ) )
 AddLine( Format( "if errorlevel 1 ", fileNameExecutableGitS, " ", "remote", " ", "add", " ", "origin", " ", '"', "%GITHUB_REMOTE%", '"' ) )
 AddLine( "" )
 AddLine( "REM Temporarily set an authenticated URL for push." )
 AddLine( Format( fileNameExecutableGitS, " ", "remote", " ", "set-url", " ", "origin", " ", '"', "%REMOTE_AUTH%", '"' ) )
 AddLine( "" )
 AddLine( "REM Push to GitHub." )
 AddLine( Format( fileNameExecutableGitS, " ", "push", " ", "-u", " ", "origin", " ", "main" ) )
 AddLine( "" )
 AddLine( "REM Restore remote URL without token." )
 AddLine( Format( fileNameExecutableGitS, " ", "remote", " ", "set-url", " ", "origin", " ", '"', "%GITHUB_REMOTE%", '"' ) )
 AddLine( "" )
 AddLine( "pause" )
 //
