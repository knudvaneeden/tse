 ...
 */
 ...
 AddLine( "------------------------------------------------------------------" )
 AddLine( "antigravity                       antigravity" )
 AddLine( "claudecode                        claudecodes" )
 AddLine( "claudecowork                      claudecowork" )
 AddLine( "claudedesktop                     claudedesktop" )
 AddLine( "codex                             codex" )
 AddLine( "copilotgithub                     copilotgithub" )
 AddLine( "copilotmicrosoft                  copilotmicrosoft" )
 AddLine( "cursor                            cursor" )
 AddLine( "cursorweb                         cursorweb" )
 AddLine( "geminicli                         geminicli" )
 AddLine( "jules                             jules" )
 ...
 ELSE
  //
  PROCFileRun4NtAliasCommandListUser( Format( s ) )
  //
 ENDIF
 //
 RETURN( s1 )
