...
FORWARD INTEGER PROC FNFileCheckVersionControlStoredB( STRING s1, STRING s2 )
FORWARD INTEGER PROC FNFileCheckVersionControlStoredCurrentB( STRING s1 )
FORWARD INTEGER PROC FNFileCheckVersionControlStoredCurrentDefaultB()
...
FORWARD INTEGER PROC FNMathGetFileGetSizeDiskDosI( STRING s1 )
FORWARD INTEGER PROC FNMathGetFileGetSizeDiskWindowsI( STRING s1 )
FORWARD INTEGER PROC FNMathGetFileSizeDiskCurrentI()
...
FORWARD INTEGER PROC FNStringGetToIntegerI( STRING s1 )
...
FORWARD STRING PROC FNStringGetFilenameOnlyCurrentS()
...
PROC Main()
 Message( FNFileCheckVersionControlStoredCurrentDefaultB() ) // gives e.g. TRUE
END
...
// library: file: check: version: control: stored: current <description></description> <version control></version control> <version>1.0.0.0.7</version> <version control></version control> (filenamemacro=checfisc.s) [<Program>] [<Research>] [kn, ri, we, 25-03-2026 21:29:22]
INTEGER PROC FNFileCheckVersionControlStoredCurrentDefaultB()
 // e.g. PROC Main()
 // e.g.  Message( FNFileCheckVersionControlStoredCurrentDefaultB() ) // gives e.g. TRUE
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNFileCheckVersionControlStoredCurrentDefaultB )
 // e.g. HELPDEF HELPDEFFNFileCheckVersionControlStoredCurrentDefaultB
 // e.g.  title = "FNFileCheckVersionControlStoredCurrentDefaultB() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 ...
 INTEGER B = FALSE
 //
 STRING directoryVersionControlS[255] = FNStringGetDirectoryVersionControlSubversionWorkingS() // change this
 //
 B = FNFileCheckVersionControlStoredCurrentB( directoryVersionControlS )
 //
 RETURN( B )
 //
END

// library: string: get: directory: version: control: working <description></description> <version>1.0.0.0.4</version> <version control></version control> (filenamemacro=getstcwo.s) [<Program>] [<Research>] [kn, am, mo, 11-10-2010 10:18:56]
...
// library: file: check: version: control: stored: current <description></description> <version control></version control> <version>1.0.0.0.4</version> <version control></version control> (filenamemacro=checfisd.s) [<Program>] [<Research>] [kn, ri, th, 26-03-2026 20:47:10]
INTEGER PROC FNFileCheckVersionControlStoredCurrentB( STRING directoryVersionControlS )
 // e.g. PROC Main()
 // e.g.  // STRING s1[255] = GetHistoryStr( _EDIT_HISTORY_, 1 ) // change this
 // e.g.  // STRING s1[255] = "G:\VERSIONCONTROL\GIT\DDD01\" // change this
 // e.g.  STRING s1[255] = "G:\VERSIONCONTROL\SUBVERSION\W1\" // change this
 // e.g.  PROCMacroRunKeep( "setwiyde" ) // operation: set: window: warn/yesno: position: x: y: default // new
 // e.g.  IF ( NOT ( Ask( "file: check: version: control: stored: current: directoryVersionControlS = ", s1, _EDIT_HISTORY_ ) ) AND ( Length( s1 ) > 0 ) ) RETURN() ENDIF
 // e.g.  Message( FNFileCheckVersionControlStoredCurrentB( s1 ) ) // gives e.g. TRUE
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNFileCheckVersionControlStoredCurrentB )
 // e.g. HELPDEF HELPDEFFNFileCheckVersionControlStoredCurrentB
 // e.g.  title = "FNFileCheckVersionControlStoredCurrentB( s1 ) help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 // e.g.  // The actual help text
 ...
 INTEGER B = FALSE
 //
 B = FNFileCheckVersionControlStoredB( FNStringGetFilenameOnlyCurrentS(), directoryVersionControlS )
 //
 RETURN( B )
 //
END
...
// library: file: check: version: control: stored <description></description> <version control></version control> <version>1.0.0.0.2</version> <version control></version control> (filenamemacro=checfifw.s) [<Program>] [<Research>] [kn, ri, th, 26-03-2026 20:32:51]
INTEGER PROC FNFileCheckVersionControlStoredB( STRING fileNameS, STRING directoryVersionControlS )
 // e.g. PROC Main()
 // e.g.  // STRING s1[255] = GetHistoryStr( _EDIT_HISTORY_, 1 ) // change this
 // e.g.  STRING s1[255] = FNStringGetFilenameOnlyCurrentS() // change this
 // e.g.  STRING s2[255] = "G:\VERSIONCONTROL\SUBVERSION\W1\" // change this
 // e.g.  PROCMacroRunKeep( "setwiyde" ) // operation: set: window: warn/yesno: position: x: y: default // new
 // e.g.  IF ( NOT ( Ask( "file: check: version: control: stored: fileNameS = ", s1, _EDIT_HISTORY_ ) ) AND ( Length( s1 ) > 0 ) ) RETURN() ENDIF
 // e.g.  PROCMacroRunKeep( "setwiyde" ) // operation: set: window: warn/yesno: position: x: y: default // new
 // e.g.  IF ( NOT ( Ask( "file: check: version: control: stored: directoryVersionControlS = ", s2, _EDIT_HISTORY_ ) ) AND ( Length( s2 ) > 0 ) ) RETURN() ENDIF
 // e.g.  Message( FNFileCheckVersionControlStoredB( s1, s2 ) ) // gives e.g. TRUE
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNFileCheckVersionControlStoredB )
 // e.g. HELPDEF HELPDEFFNFileCheckVersionControlStoredB
 // e.g.  title = "FNFileCheckVersionControlStoredB( s1, s2 ) help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 // e.g.  // The actual help text
 ...
 INTEGER I2 = 0
 //
 I1 = FNMathGetFileSizeDiskCurrentI()
 //
 I2 = FNFileGetSizeDiskI( Format( AddTrailingSlash( directoryVersionControlS ), fileNameS ) )
 //
 B = ( I1 == I2 )
 //
 RETURN( B )
...
// library: string: get: filename: only: current <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=getstocv.s) [<Program>] [<Research>] [kn, ri, we, 25-03-2026 21:38:40]
STRING PROC FNStringGetFilenameOnlyCurrentS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetFilenameOnlyCurrentS() ) // gives e.g. "ddd.s"
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNStringGetFilenameOnlyCurrentS )
 // e.g. HELPDEF HELPDEFFNStringGetFilenameOnlyCurrentS
 // e.g.  title = "FNStringGetFilenameOnlyCurrentS() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 // e.g.  // The actual help text
 ...
 //
 fileNameS = SplitPath( CurrFileName(), _NAME_ | _EXT_ )
 //
 RETURN( fileNameS )
 //
END
...
// library: math: get: file: size: disk: current <description>file: size: disk: current: return the total amount of bytes the current file takes on disk</description> <version>1.0.0.0.2</version> <version control></version control> (filenamemacro=getmadcu.s) [<Program>] [<Research>] [kn, ri, tu, 02-01-2001 03:32:03]
INTEGER PROC FNMathGetFileSizeDiskCurrentI()
 // e.g. PROC Main()
 // e.g.  Message( FNMathGetFileSizeDiskCurrentI() ) // gives e.g. "12345"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNFileGetSizeDiskI( FNStringGetFilenameCurrentS() ) )
 //
END

// library: file: get: size: disk <description>file: size: disk: return the total amount of bytes the file takes on disk</description> <version control></version control> <version>1.0.0.0.3</version> (filenamemacro=getfisdi.s) [<Program>] [<Research>] [kn, ri, tu, 02-01-2001 03:32:03]
INTEGER PROC FNFileGetSizeDiskI( STRING filenameS )
 // e.g. PROC Main()
 // e.g.  Message( FNFileGetSizeDiskI( "c:\i.m" ) ) // gives e.g. 16664 as the filesize in bytes of this file
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 #IFDEF WIN32
  //
  RETURN( FNMathGetFileGetSizeDiskWindowsI( filenameS ) )
  //
 #ELSE
  //
  RETURN( FNMathGetFileGetSizeDiskDosI( filenameS ) )
  //
 #ENDIF
 //
END
...
// library: math: get: file: get: size: disk: windows <description>file: get: size: disk: windows: return the total amount of bytes the file takes on disk / TSE for Windows only</description> <version control></version control> <version>1.0.0.0.5</version> (filenamemacro=getfidwi.s) [<Program>] [<Research>] [kn, ri, we, 29-08-2001 01:59:13]
INTEGER PROC FNMathGetFileGetSizeDiskWindowsI( STRING filenameS )
 // e.g. PROC Main()
 // e.g.  Message( FNMathGetFileGetSizeDiskWindowsI( "c:\autoexec.nt" ) ) // gives e.g. 12345 bytes as filesize on disk
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 #IFDEF WIN32
  //
  INTEGER filesizeI = FNMathGetInitializeNewI()
  //
  // IF FindThisFile( QuotePath( filenameS ), _HIDDEN_ | _SYSTEM_ | _READONLY_ )
  ...
  ELSE
   //
   PROCWarnCons( filenameS, "not found (thus filesize in bytes could not be determined)" )
   //
   filesizeI = 0
   //
  ENDIF
...
// library: math: get: file: get: size: disk: dos <description>file: get: size: disk: dos: return the total amount of bytes the file takes on disk / TSE for DOS only</description> <version control></version control> <version>1.0.0.0.6</version> (filenamemacro=getfiddo.s) [<Program>] [<Research>] [kn, ri, tu, 02-01-2001 03:32:03]
INTEGER PROC FNMathGetFileGetSizeDiskDosI( STRING filenameS )
 // e.g. PROC Main()
 // e.g.  Message( FNMathGetFileGetSizeDiskDosI( "c:\autoexec.nt" ) ) // gives e.g. 12345 bytes as filesize on disk
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 ...
 #ELSE
  //
  #IF EDITOR_VERSION == 0x3000 // TSE 3.0
   //
   STRING dtaS[80] = FNStringGetInitializeNewStringS()
   //
   STRING s[50] = FNStringGetInitializeNewStringS()
   //
   SetDTA( dtaS )
   //
   IF FNMathCheckLogicNotB( FindFirst( filenameS, _READONLY_ | _HIDDEN_ | _SYSTEM_ ) )
    //
   ...
   s = DecodeDTA( dtaS )
   //
   RETURN( FNStringGetToIntegerI( Trim( s[16:9] ) ) )
  //
  #ENDIF
  //
 #ENDIF
...
// library: string: get: to: integer convert a string to an integer <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getsttio.s) [<Program>] [<Research>] [string to number] [kn, ni, mo, 03-08-1998 00:32:54]
INTEGER PROC FNStringGetToIntegerI( STRING s )
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetToIntegerI( "3" ) ) // gives e.g. 3
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
