...
FORWARD MENU MENUQTroubleshootJobMainSave()
FORWARD PROC Main()
...
PROC Main()
 PROCMacroRunKeep( "setwiyde" ) // operation: set: window: warn/yesno: position: x: y: default // new [kn, ri, we, 12-05-2021 12:16:42]
 MENUQTroubleshootJobMainSave()
END
...
// library: q: troubleshoot: job: main: save <description></description> <version control></version control> <version>1.0.0.0.21</version> <version control></version control> (filenamemacro=trouqmsa.s) [<Program>] [<Research>] [kn, ri, sa, 22-05-2021 16:19:25]
MENU MENUQTroubleshootJobMainSave()
 // e.g. PROC Main()
 // e.g.  PROCMacroRunKeep( "setwiyde" ) // operation: set: window: warn/yesno: position: x: y: default // new [kn, ri, we, 12-05-2021 12:16:42]
 // e.g.  MENUQTroubleshootJobMainSave()
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 ...
 // y = 1
 history
 title = "OPERATION: TROUBLESHOOT: SAVE"
 //
 "OPERATION: SAVE: BLOCK: DOWNLOAD", , divide
 "&L: operation: save: block: download: wget: file: zip: all", PROCMacroRunPurge( "saveblza" ), , "l: operation: save: block: download: wget: file: zip: all"
 //
 "OPERATION: SAVE: BLOCK: FILENAME", , divide
 "&P: operation: save: block: filename: create", PROCMacroRunPurge( "saveblfc" ), , "p: operation: save: block: filename: create"
 //
 "OPERATION: SAVE: DATABASE", , divide
 "&Q: operation: save: database: backup: mysql: dump", PROCMacroRunPurge( "savedamd" ), , "q: operation: save: database: backup: mysql: dump"
 "&K: operation: save: database: backup: mysql: dump: default", PROCMacroRunPurge( "savedadd" ), , "k: operation: save: database: backup: mysql: dump: default"
 //
 "", , divide
 "&C: operation: save: file: copy: as", PROCMacroRunPurge( "savefica" ), , "c: operation: save: file: copy: as"
 //
 "&A: operation: save: file: save as: backup: job: to: oldest: default + current: dos", PROCMacroRunPurge( "saveficm" ), , "a: operation: save: file: save as: backup: job: to: oldest: default + current: dos"
 //
 "OPERATION: SAVE: FILE: BACKUP: ALL", , divide
 "&1: operation: update: program: file: backup: ri: alias: knud [backupknudalltoday.bat]", PROCMacroRunPurge( "runprral" ), , "1: operation: update: program: file: backup: ri: alias: knud [backupknudalltoday.bat]"
 //
 "OPERATION: SAVE: FILE: DRIVE: CLOUD", , divide
 "&9: operation: save: file: drive: cloud: input", PROCMacroRunPurge( "savefici" ), , "9: operation: save: file: drive: cloud: input"
 //
 "OPERATION: SAVE: FILE: HISTORY", , divide
 "&H: operation: save: file: history: all: default", PROCMacroRunPurge( "savefiad" ), , "h: operation: save: file: history: all: default"
 "", , divide
 "&E: operation: save: file: history: all", PROCMacroRunPurge( "savefiha" ), , "e: operation: save: file: history: all"
 //
 "OPERATION: SAVE: FILE: BACKUP", , divide
 "&X: operation: save: file: backup: library", PROCMacroRunPurge( "runprakp" ), , "x: operation: save: file: backup: library"
 //
 "&U: operation: save: file: backup: revision: next: directory: backup: message", PROCMacroRunPurge( "savefimd" ), , "u: operation: save: file: backup: revision: next: directory: backup: message"
 "&B: operation: save: file: backup: revision: next: default: message", PROCMacroRunPurge( "savefibn" ), , "b: operation: save: file: backup: revision: next: default: message"
 "&D: operation: save: file: backup: revision: next: harddisk: external: usb: message", PROCMacroRunPurge( "savefinm" ), , "d: operation: save: file: backup: revision: next: harddisk: external: usb: message"
 //
 "OPERATION: SAVE: FILE: STATE", , divide
 "&I: operation: save: file: editor: tse: state", PROCMacroRunPurge( "saveprtt" ), , "i: operation: save: file: editor: tse: state"
 "", , divide
 "&2: operation: save: file: editor: tse: state: crud: list", PROCMacroRunPurge( "creabucl" ), , "2: operation: save: file: editor: tse: state: crud: list"
 "", , divide
 "&N: operation: save: editor: tse: state: filename", PROCMacroRunPurge( "saveprft" ), , "n: operation: save: editor: tse: state: filename"
 //
 "OPERATION: SAVE: FILE: STATE: HISTORY", , divide
 "&T: operation: save: program: state+history: editor: text: tse", PROCMacroRunPurge( "saveprtu" ), , "t: operation: save: program: state+history: editor: text: tse"
 "", , divide
 "&O: operation: save: program: state: history: editor: text: filename: tse", PROCMacroRunPurge( "saveprfu" ), , "o: operation: save: program: state: history: editor: text: filename: tse"
 //
 "OPERATION: SAVE: FILE: TIME: MANAGEMENT", , divide
 "&*: operation: save: file: time: management: dddtimelogdok: current", PROCMacroRunPurge( "savefidc" ), , "*: operation: save: file: time: management: dddtimelogdok: current"
 //
 "OPERATION: SAVE: FILE: VERSION: CONTROL: GIT", , divide
 "&G: operation: save: file: file: version: control: git: simplest: case", PROCMacroRunPurge( "git_knud" ), , "g: operation: save: file: file: version: control: git: simplest: case"
 "&Y: operation: save: file: to: directory: local: git: version: control", PROCMacroRunPurge( "savefivc" ), , "y: operation: save: file: to: directory: local: git: version: control"
 "&Z: operation: save: file: to: directory: local: git: version: control (Carlo Hogeveen)", PROCMacroRunPurge( "git" ), , "z: operation: save: file: to: directory: local: git: version: control (carlo hogeveen)"
 "&V: operation: save: file: file: version: control: all", PROCMacroRunPurge( "savefich" ), , "v: operation: save: file: file: version: control: all"
 //
 "OPERATION: SAVE: FILE: VERSION: CONTROL: SUBVERSION", , divide
 "&F: operation: save: file: save: current: version: control: subversion: not: default", PROCMacroRunPurge( "savefisf" ), , "f: operation: save: file: save: current: version: control: subversion: not: default"
 "", , divide
 "&S: operation: save: file: current: version: control: subversion: create: update", PROCMacroRunPurge( "updafisc" ), , "s: operation: save: file: current: version: control: subversion: create: update"
 "", , divide
 "OPERATION: SAVE: FILE: UNICODE", , divide
 "&W: operation: save: file: unicode: russian: transliteral: block", PROCMacroRunPurge( "savefitb" ), , "w: operation: save: file: unicode: russian: transliteral: block"
 //
 "OPERATION: SAVE: MENU", , divide
 "&M: operation: save: menu: default ", PROCMacroRunPurge( "saveqqsa" ), , "m: operation: save: menu: default"
 //
 "OPERATION: SAVE: RECORD", , divide
 "&J: operation: save: record: create: file: backup: version: next", PROCMacroRunPurge( "crearevn" ), , "j: operation: save: record: create: file: backup: version: next"
 //
 "OPERATION: SAVE: RECORD: FILE: VERSION: CONTROL", , divide
 "&R: operation: save: record: version: control: subversion: current", PROCMacroRunPurge( "saveresc" ), , "r: operation: save: record: version: control: subversion: current"
 //
END
