...
FORWARD INTEGER PROC FNClipboardCheckCopyTseB()
...
FORWARD PROC Main()
FORWARD PROC PROCClipboardCopyTse()
FORWARD PROC PROCClipboardCopyWindowsMessage( STRING s1 )
...
FORWARD STRING PROC FNStringGetClipboardCaseCentralS( STRING s1, STRING s2 )
FORWARD STRING PROC FNStringGetClipboardCaseTseS()
FORWARD STRING PROC FNStringGetClipboardCaseWindowsS()
FORWARD STRING PROC FNStringGetClipboardCopyCaseTseS()
...
FORWARD STRING PROC FNStringGetTokenCaseCapitalizeCentralS( STRING s1 )
FORWARD STRING PROC FNStringGetTokenCaseNounClipboardS()
FORWARD STRING PROC FNStringGetTokenCaseOperationCopyS()
...
FORWARD STRING PROC FNStringGetTokenNameClipboardWindowsS()
FORWARD STRING PROC FNStringGetTokenNameClipboard_TseCaseUpperS()
FORWARD STRING PROC FNStringGetTokenNameClipboard_WindowsCapitalizeS()
FORWARD STRING PROC FNStringGetUserNameFirstS()
FORWARD STRING PROC FNStringGetUserNameLastS()
FORWARD STRING PROC FNStringGetWordCaseCapitalizeS( STRING s1 )
FORWARD STRING PROC FNStringGetWordRestS( STRING s1, INTEGER i1 )
FORWARD STRING PROC FNStringGet_ClipboardCopyMessageCentralS( STRING s1, STRING s2 )
...
PROC Main()
 Message( FNBlockRunArtificialIntelligenceCase() ) // gives e.g. ...""
END
...
// library: block: run: artificial: intelligence: case <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=runblica.s) [<Program>] [<Research>] [kn, ri, su, 15-02-2026 22:19:54]
INTEGER PROC FNBlockRunArtificialIntelligenceCase()
 // e.g. PROC Main()
 // e.g.  Message( FNBlockRunArtificialIntelligenceCase() ) // gives e.g. ...""
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 INTEGER B = FALSE
 //
 STRING infoS[255] = "Block copied to Microsoft Windows clipboard. Paste it in the AI prompt"
 //
 ...
 //
 PROCClipboardCopyWindowsMessage( infoS )
 //
 B = FNProgramRunBrowserInternetUrlArtificialIntelligenceB()
 //
 RETURN( B )
 //
END

// library: clipboard: copy: windows: message <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=copyclwm.s) [<Program>] [<Research>] [kn, zoe, we, 15-11-2000 12:20:20]
PROC PROCClipboardCopyWindowsMessage( STRING infoS )
 // e.g. PROC Main()
 // e.g.  STRING s[255] = ""
 // e.g.  s = FNStringGetInputS( "string: clipboard: copy + message copy to Windows clipboard: string = ", "test" )
 // e.g.  IF FNKeyCheckPressEscapeB( s ) RETURN() ENDIF
 // e.g.  PROCClipboardCopyWindowsMessage( s )
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 FNStringGet_ClipboardCopyMessageCentralS( infoS, FNStringGetClipboardCaseWindowsS() )
 //
END
...
// library: string: get: clipboard: copy: message: central <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=getstmcn.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:16:57]
STRING PROC FNStringGet_ClipboardCopyMessageCentralS( STRING infoS, STRING caseS )
 // e.g. PROC Main()
 // e.g.  Message( FNStringGet_ClipboardCopyMessageCentralS( "test", FNStringGetClipboardCaseWindowsS() ) ) // gives e.g. "test"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 CASE caseS
  //
  WHEN FNStringGetClipboardCopyCaseTseS()
   //
   PROCClipboardCopyTse()
   //
   PROCMessage( infoS )
  //
  WHEN FNStringGetClipboardCaseWindowsS()
   //
   // PROCBlockCopyClipboardWindows() // old [kn, vo, fr, 13-12-2013 17:53:05]
   CopyToWinClip( infoS ) // new [kn, vo, fr, 13-12-2013 17:53:14]
   //
   PROCMessage( infoS )
   //
  OTHERWISE
   //
   PROCErrorCaseNotFound( FNStringGetEmptyS(), "FNStringGet_ClipboardCopyMessageCentralS(", caseS )
   //
 ENDCASE
 //
...
// library: string: get: clipboard: copy: windows <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcwi.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:18:42]
STRING PROC FNStringGetClipboardCaseWindowsS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetClipboardCaseWindowsS() ) // gives e.g. "clipboard Windows"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetClipboardCaseCentralS( FNStringGetTokenCaseNounClipboardS(), FNStringGetTokenNameClipboard_WindowsCapitalizeS() ) )
 //
END

// library: string: get: clipboard: copy: tse <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcts.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:18:14]
STRING PROC FNStringGetClipboardCopyCaseTseS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetClipboardCopyCaseTseS() ) // gives e.g. "copy clipboard TSE"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetClipboardCaseCentralS( FNStringGetTokenCaseOperationCopyS(), FNStringGetClipboardCaseTseS() ) )
 //
END

// library: cut/copy/paste: copy the current marked block to the TSE clipboard <description></description> <version control></version control> <version>1.0.0.0.2</version> (filenamemacro=cliptcop.s) [<Program>] [<Research>] [kn, zoe, tu, 15-06-1999 23:55:56]
PROC PROCClipboardCopyTse()
 // e.g. PROC Main()
 // e.g.  PROCClipboardCopyTse()
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 IF FNMathCheckLogicNotB( FNClipboardCheckCopyTseB() )
  //
  PROCWarn( "Copy was not successful" )
  //
 ENDIF
 //
END

// library: message <description></description> <version>1.0.0.0.4</version> <version control></version control> (filenamemacro=memessag.s) [<Program>] [<Research>] [kn, zoe, we, 16-06-1999 01:07:07]
PROC PROCMessage( STRING s )
 // e.g. PROC Main()
 // e.g.  PROCMessage( "test" )
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
...
// library: string: get: clipboard: case: central <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=getstcei.s) [<Program>] [<Research>] [kn, ri, sa, 05-11-2005 21:36:25]
STRING PROC FNStringGetClipboardCaseCentralS( STRING s1, STRING s2 )
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetClipboardCaseCentralS( "copy", "clipboard windows" ) ) // gives e.g. "copy clipboard windows"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetConsS( s1, s2 ) )
 //
END

// library: string: get: clipboard: case <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcce.s) [<Program>] [<Research>] [kn, ri, sa, 05-11-2005 21:59:47]
STRING PROC FNStringGetTokenCaseNounClipboardS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenCaseNounClipboardS() ) // gives e.g. "clipboard"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
...
// library: string: get: token: name: clipboard: windows: capitalize <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcwj.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:39:12]
STRING PROC FNStringGetTokenNameClipboard_WindowsCapitalizeS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenNameClipboard_WindowsCapitalizeS() ) // gives e.g. "Windows"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetTokenCaseCapitalizeCentralS( FNStringGetTokenNameClipboardWindowsS() ) )
 //
END

// library: string: get: case: copy <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstccp.s) [<Program>] [<Research>] [kn, ri, sa, 05-11-2005 21:35:03]
STRING PROC FNStringGetTokenCaseOperationCopyS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenCaseOperationCopyS() ) // gives e.g. "copy"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
...
// library: string: get: clipboard: copy: tse <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcts.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:18:14]
STRING PROC FNStringGetClipboardCaseTseS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetClipboardCaseTseS() ) // gives e.g. "clipboard TSE"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetClipboardCaseCentralS( FNStringGetTokenCaseNounClipboardS(), FNStringGetTokenNameClipboard_TseCaseUpperS() ) )
 //
END
...
// library: cut/copy/paste: copy the current marked block to the TSE clipboard <description></description> <version control></version control> <version>1.0.0.0.2</version> (filenamemacro=copyclct.s) [<Program>] [<Research>] [kn, ri, tu, 25-12-2001 07:01:07]
INTEGER PROC FNClipboardCheckCopyTseB()
 // e.g. PROC Main()
 // e.g.  Message( FNClipboardCheckCopyTseB() ) // gives e.g. TRUE
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( Copy( _DEFAULT_ ) )
 //
END
...
// library: string: get: token: case: capitalize: central <description></description> <version control></version control> <version>1.0.0.0.1</version> <version control></version control> (filenamemacro=getstceh.s) [<Program>] [<Research>] [kn, ri, su, 06-11-2005 19:58:48]
STRING PROC FNStringGetTokenCaseCapitalizeCentralS( STRING s )
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenCaseCapitalizeCentralS( "test" ) ) // gives "Test"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetWordCaseCapitalizeS( s ) )
 //
END

// library: string: get: name: clipboard: windows <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstcwj.s) [<Program>] [<Research>] [kn, ri, su, 17-04-2005 17:39:12]
STRING PROC FNStringGetTokenNameClipboardWindowsS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenNameClipboardWindowsS() ) // gives e.g. "windows"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
...
STRING PROC FNStringGetTokenNameClipboard_TseCaseUpperS()
 // e.g. PROC Main()
 // e.g.  Message( FNStringGetTokenNameClipboard_TseCaseUpperS() ) // gives e.g. "TSE"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetTokenLanguageTseCaseUpperS() )
 //
END
...
// library: string: uppercase/lowercase: capitalize: capitalize the given word <description></description> <version control></version control> <version>1.0.0.0.1</version> (filenamemacro=getstccb.s) [<Program>] [<Research>] [kn, zoe, fr, 24-11-2000 18:58:54]
STRING PROC FNStringGetWordCaseCapitalizeS( STRING s )
 // e.g. PROC Main()
 // e.g.  STRING s1[255] = FNStringGetInitializeNewStringS()
 // e.g.  s1 = FNStringGetInputS( "string: get: case: capitalize: string = ", "test" )
 // e.g.  IF FNKeyCheckPressEscapeB( s1 ) RETURN() ENDIF
 // e.g.  Message( FNStringGetWordCaseCapitalizeS( s1 ) ) // gives e.g. "Test"
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 RETURN( FNStringGetCaseUpperS( FNStringGetCharacterFirstS( s ) ) + FNStringGetCaseLowerS( FNStringGetCharacterWithoutFirstS( s ) ) )
 //
END
