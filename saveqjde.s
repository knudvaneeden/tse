...
FORWARD MENU MENUQSaveJobDefault()
FORWARD PROC Main()
...
// library: q: save: job: default <description></description> <version control></version control> <version>1.0.0.0.49</version> (filenamemacro=saveqjde.s) [<Program>] [<Research>] [kn, am, th, 28-05-2009 10:36:57]
MENU MENUQSaveJobDefault()
 // e.g. PROC Main()
 // e.g.  MENUQSaveJobDefault()
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 ...
 y = 1 // y = 29
 history
 title = "OPERATION: SAVE: JOB: DEFAULT"
 ...
 "OPERATION: SAVE: FILE", , divide
 "&B: operation: save: file: backup: revision: next", PROCMacroRunPurge( "savefibn" ), , "b: operation: save: file: backup: revision: next"
 "", , divide
 "&C: operation: save: file: copy: as", PROCMacroRunPurge( "savefica" ), , "c: operation: save: file: copy: as"
 "", , divide
 "&F: operation: save: file: save: current: version: control: system: not: default", PROCMacroRunPurge( "savefisf" ), , "f: operation: save: file: save: current: version: control: system: not: default"
 "", , divide
 "&V: operation: save: file: save: current: version: control: system", PROCMacroRunPurge( "filesavc" ), , "v: operation: save: file: save: current: version: control: system"
 "", , divide
 ...
 "&D: operation: save: file: drive: cloud: input", PROCMacroRunPurge( "savefici" ), , "d: operation: save: file: drive: cloud: input"
 ...
 "", , divide
 "&S: operation: save: file: editor: tse: state: crud: list", PROCMacroRunPurge( "creabucl" ), , "s: operation: save: file: editor: tse: state: crud: list"
 "", , divide
 ...
 "OPERATION: SAVE: FILE: TO: VERSION: CONTROL: GIT", , divide
 "&G: operation: save: file: to: directory: local: git: version: control", PROCMacroRunPurge( "savefivc" ), , "g: operation: save: file: to: directory: local: git: version: control"
 ...
 "&R: operation: save: file: unicode: russian: transliteral: block", PROCMacroRunPurge( "savefitb" ), , "r: operation: save: file: unicode: russian: transliteral: block"
END
