...
Run the TSE macro abrev, then type a letter b and put the cursor
immediately after it. Then press <F12>.
That will expand to:
...
Run the TSE macro abrev, then type a letter c and put the cursor
immediately after it. Then press <F12>.
That will expand to:
