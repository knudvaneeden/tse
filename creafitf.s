...
FORWARD INTEGER PROC FNFileCreateScreenshotToFileB()
...
PROC Main()
 Message( FNFileCreateScreenshotToFileB() ) // gives e.g. TRUE
END
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNFileCreateScreenshotToFileB )
 // e.g. HELPDEF HELPDEFFNFileCreateScreenshotToFileB
 // e.g.  title = "FNFileCreateScreenshotToFileB() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
