...
PROC Main()
 // STRING s1[255] = "/mnt/c/temp/ddd.txt" // TSE for Linux WSL / change this
 // STRING s1[255] = "/home/knudvaneeden/c/temp/tse_linux/knud/ddd.txt" // TSE for Linux non-WSL / change this
 STRING s1[255] = "c:\temp\ddd.txt" // TSE for Microsoft Windows / change this
 IF ( NOT ( Ask( "file: get: size: disk: fileNameS = ", s1, _EDIT_HISTORY_ ) ) AND ( Length( s1 ) > 0 ) ) RETURN() ENDIF
 Warn( FNFileGetSizeDiskI( s1 ) ) // gives e.g. 12345 bytes as filesize on disk
END
