...
// library: file: get: download: github: file: version: control <description></description> <version control></version control> <version>1.0.0.0.12</version> <version control></version control> (filenamemacro=getfivco.s) [<Program>] [<Research>] [kn, ri, fr, 09-02-2018 02:29:16]
INTEGER PROC FNFileGetDownloadGithubFileVersionControlB( STRING someLocaldirectoryS, STRING githubDirectoryS, STRING fileNameExecutableGitS, STRING fileNameExecutableTccS )
 ...
 EditFile( fileNameS )
 //
 AddLine( Format( "md", " ", someLocaldirectoryS ) ) // if the directory does not exist yet, create that directory
