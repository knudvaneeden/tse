...
FORWARD PROC PROCFileEditInputListHistoryBbcTaalKnud()
...
FORWARD PROC PROCHistoryAddString( STRING s1, INTEGER i1 )
...
FORWARD STRING PROC FNStringGetFilePathGoogledriveMicrosoftWindowsS()
FORWARD STRING PROC FNStringGetFilePathUserCurrentMicrosoftWindowsS()
...
PROC Main()
 PROCFileEditInputListHistoryBbcTaalKnud()
END
...
PROC PROCFileEditInputListHistoryBbcTaalKnud()
 ...
 // e.g. <F12> Main()
 //
 STRING s[255] = GetHistoryStr( _EDIT_HISTORY_, 1 )
 //
 STRING fileNameS[255] = ""
 //
 // this is a stack, thus first in, first out [kn, ri, su, 24-11-2024 11:12:09]
 //
 // DelHistoryStr( _EDIT_HISTORY_, 1 ) // [kn, ri, su, 19-04-2009 20:17:36]
 //
 // PROCMacroRunPurge( "editfild" ) // add history 'c:\bbc\taal\kaspersky\delphi\' to edit file history
 //
 // PROCMacroRunPurge( "editfids" ) // add history 'c:\bbc\taal\kaspersky\delphi\suite' to edit file history
 //
 // PROCMacroRunPurge( "editfird" ) // add history 'e:\RIVIERARENTAL23AUGUST2004BACKUP\www\' to edit file history
 //
 // PROCMacroRunPurge( "editfidk" ) // add history 'e:\update\to_hp\' to edit file history
 //
 // PROCMacroRunPurge( "editfide" ) // add history 'e:\addhp.dok' to edit file history
 //
 // PROCMacroRunPurge( "editfidh" ) // add history 'g:\addhp.dok' to edit file history
 //
 // PROCMacroRunPurge( "editfisk" ) // add history '<drive>:\knud\' to edit file history
 //
 // PROCMacroRunPurge( "editfiad" ) // add history '<drive>:\4dos\' to edit file history // old [kn, ri, su, 24-11-2024 11:09:37]
 //
 // PROCMacroRunPurge( "editfijd" ) // add history '<drive>:\temp\add<job>\' to edit file history // old [kn, ri, su, 24-11-2024 11:10:30]
 //
 // PROCMacroRunPurge( "editfiqc" ) // add history '<drive>:\bbc\taal\qed' to edit file history // old [kn, ri, su, 24-11-2024 11:15:20]
 //
 // PROCMacroRunPurge( "editfisf" ) // add history 'c:\users\<user name>\documents\' to edit file history // added [kn, vo, we, 08-01-2020 10:47:41] // old [kn, ri, su, 24-11-2024 11:17:09]
 //
 // PROCMacroRunPurge( "editfise" ) // add history 'c:\users\<user name>\downloads\' to edit file history // added [kn, vo, we, 08-01-2020 10:47:46] // old [kn, ri, su, 24-11-2024 11:17:13]
 //
 // PROCMacroRunPurge( "editfisd" ) // add history 'c:\users\<user name>\desktop\' to edit file history // added [kn, vo, we, 01-06-2016 13:24:36] // old [kn, ri, su, 24-11-2024 11:17:17]
 //
 // PROCMacroRunPurge( "editfiwd" ) // add history '<drive>:\inetpub\wwwroot\' to edit file history // old [kn, ri, su, 24-11-2024 11:17:56]
 //
 // PROCMacroRunPurge( "editfisn" ) // add history '<drive>:\mydownloadfiles\' to edit file history // old [kn, ri, su, 24-11-2024 11:19:04]
 //
 // PROCMacroRunPurge( "editfije" ) // add history '<drive>:\softwareag' to edit file history // added [kn, ri, su, 24-11-2024 11:15:03] // old [kn, ri, su, 24-11-2024 11:44:40]
 //
 // PROCMacroRunPurge( "editfidl" ) // add history '<drive>:\temp\knud\' to edit file history // old [kn, ri, su, 24-11-2024 11:45:02]
 //
 // PROCMacroRunPurge( "editfidc" ) // add history '<drive>:\bbc\taal\ddd' to edit file history // old [kn, ri, mo, 25-11-2024 02:41:53]
 //
 // PROCHistoryAddString( "f:\wordproc\tse_beta\dock.txt",  _EDIT_HISTORY_ ) // added [kn, ri, su, 12-01-2025 01:19:33]
 //
 IF ( ( WhichOs() == _WINDOWS_ ) OR ( WhichOs() == _WINDOWS_NT_ ) )
  //
  fileNameS = QuotePath( AddTrailingSlash( FNStringGetFilePathGoogledriveMicrosoftWindowsS() ) )
  //
  fileNameS = Trim( fileNameS )
  //
  IF ( RightStr( fileNameS, 1 ) == '"' )
   //
   fileNameS = LeftStr( fileNameS, Length( fileNameS ) - 1 ) // if a double quote '"' at the end remove it. Because only the first double quote is significant.
   //
  ENDIF
  //
  PROCHistoryAddString( fileNameS,  _EDIT_HISTORY_ ) // added [kn, ri, su, 07-12-2025 22:15:48]
  //
 ENDIF
 //
 ...
 //
 PROCMacroRunPurge( "editfilb" ) // add history '<drive>:\bbc\taal\bib' to edit file history
 //
 PROCMacroRunPurge( "editfitm" ) // add history '<drive>:\bbc\taal\' to edit file history
 //
 PROCHistoryAddString( "c:\temp\tse_linux\linuxwsl.c", _EDIT_HISTORY_ ) // added [kn, ri, mo, 23-12-2024 18:56:16]
 //
 PROCHistoryAddString( "g:\mydownloadfiles\from_job_to_home\tse-linux-4.50.tgz", _EDIT_HISTORY_ ) // added [kn, ri, su, 15-12-2024 22:59:41]
 //
 PROCHistoryAddString( "c:\temp\tse_linux\tse\read.me.linux",  _EDIT_HISTORY_ ) // added [kn, ri, fr, 13-12-2024 17:21:30]
 //
 PROCHistoryAddString( "c:\temp\tse_linux\tse\",  _EDIT_HISTORY_ ) // added [kn, ri, su, 01-12-2024 00:11:56]
 //
 PROCHistoryAddString( "c:\temp\tse_linux\tse\ddd.s",  _EDIT_HISTORY_ ) // added [kn, ri, su, 01-12-2024 00:12:04]
 //
 PROCHistoryAddString( "c:\temp\ddd",  _EDIT_HISTORY_ ) // added [kn, ri, mo, 25-11-2024 02:35:33]
 //
 PROCHistoryAddString( "c:\temp\ddd.txt",  _EDIT_HISTORY_ ) // added [kn, ri, su, 24-11-2024 11:16:02]
 //
 PROCHistoryAddString( "c:\temp\ddd.sh",  _EDIT_HISTORY_ ) // added [kn, ri, th, 12-12-2024 03:19:46]
 //
 PROCHistoryAddString( "c:\temp\ddd.s",  _EDIT_HISTORY_ ) // added [kn, ri, su, 24-11-2024 11:16:02]
 //
 PROCHistoryAddString( "c:\temp\tse_linux\",  _EDIT_HISTORY_ ) // added [kn, ri, fr, 05-09-2025 13:49:29]
 //
 PROCHistoryAddString( "c:\temp\tse_linux\knud\ddd.s",  _EDIT_HISTORY_ ) // added [kn, ri, tu, 24-06-2025 15:30:40]
 //
...
// library: string: get: file: path: googledrive: microsoft: windows <description></description> <version control></version control> <version>1.0.0.0.0</version> <version control></version control> (filenamemacro=getstmwo.s) [<Program>] [<Research>] [kn, ri, fr, 26-12-2025 18:29:21]
STRING PROC FNStringGetFilePathGoogledriveMicrosoftWindowsS()
 // e.g. PROC Main()
 // e.g.  Warn( FNStringGetFilePathGoogledriveMicrosoftWindowsS() ) // gives e.g. "c:\users\<yourcurrentmicrosoftwindowsusername>"
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
 ...
 */
 ...
 // ===
 //
 // e.g. // QuickHelp( HELPDEFFNStringGetUserCurrentMicrosoftWindowsS )
 // e.g. HELPDEF HELPDEFFNStringGetFilePathUserCurrentMicrosoftWindowsS
 // e.g.  title = "FNStringGetFilePathUserCurrentMicrosoftWindowsS() help" // The help's caption
 // e.g.  x = 100 // Location
 // e.g.  y = 3 // Location
 // e.g.  //
 ...
 STRING s[255] = ""
 //
 s = FNStringGetFilePathUserCurrentMicrosoftWindowsS()
 //
 s = AddTrailingSlash( s )
 //
 s = Format( s, "Google Drive" )
 //
 RETURN( s )
 //
END

// library: history: add: string <description>history: add: (Add given string to the specified history List). Syntax: AddHistoryStr( STRING s, INTEGER history_num ). See also: DelHistory(), GetFreeHistory(), Ask(). Variables: MaxHistorySize</description> <version>1.0.0.0.4</version> <version control></version control> (filenamemacro=addhiast.s) [<Program>] [<Research>] [[kn, zoe, we, 16-06-1999 01:06:30]
PROC PROCHistoryAddString( STRING inS, INTEGER historynumberI )
 // e.g. PROC Main()
 // e.g.  PROCHistoryAddString( "c:\ddd.dok", _EDIT_HISTORY_ ) // see EditFile(), InsertFile(), SaveBlock(), SaveAs()
 // e.g.  PROCHistoryAddString( "c:\ddd.dok", _NEWNAME_HISTORY_ ) // see: ChangeCurrFilename()
 // e.g.  PROCHistoryAddString( "c:\clock.mac", _EXECMACRO_HISTORY_ ) // see: ExecMacro()
 // e.g.  PROCHistoryAddString( "c:\gfall.mac", _LOADMACRO_HISTORY_ ) // see: LoadMacro()
 // e.g.  PROCHistoryAddString( "c:\keys.mac", _KEYMACRO_HISTORY_ ) // see: LoadKeyMacro(), SaveKeyMacro()
 // e.g.  PROCHistoryAddString( "131231", _GOTOLINE_HISTORY_ ) // see: GotoLine()
 // e.g.  PROCHistoryAddString( "80", _GOTOCOLUMN_HISTORY_ ) // see: GotoColumn()
 // e.g.  // PROCHistoryAddString( "GetKey()", _REPEATCOMMAND_HISTORY_ ) // see: RepeatCmd()
 // e.g.  PROCHistoryAddString( "dir", _DOS_HISTORY_ ) // see: Dos()
 // e.g.  PROCHistoryAddString( "ix", _FINDOPTIONS_HISTORY_ ) // see: Find()
 // e.g.  PROCHistoryAddString( " ", _FILLBLOCK_HISTORY_ ) // see: FillBlock()
 // e.g.  PROCHistoryAddString( "knud", _REPLACE_HISTORY_ ) // see: Replace()
 // e.g.  PROCHistoryAddString( "ix", _REPLACEOPTIONS_HISTORY_ ) // see: Replace()
 // e.g.  PROCHistoryAddString( "knud", _FIND_HISTORY_ ) // see: Find(), Replace()
 // e.g. END
 // e.g.
 // e.g. <F12> Main()
 //
 // If the string equals '<ESCAPE>' then do not add it to the history
 //
 STRING s[255] = inS
 //
 IF ( FNKeyCheckPressEscapeB( s ) )
  //
  RETURN()
  //
 ENDIF
 ...
 //
 AddHistoryStr( s, historynumberI )
 //
END
...
STRING PROC FNStringGetFilePathUserCurrentMicrosoftWindowsS()
 // e.g. PROC Main()
 // e.g.  Warn( FNStringGetFilePathUserCurrentMicrosoftWindowsS() ) // gives e.g. "c:\users\<yourcurrentmicrosoftwindowsusername>"
 // e.g. END
 // e.g.
 // e.g. <Ctrl F12> Main()
 //
