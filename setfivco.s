...
PROC Main()
 //
 STRING s1[255] = "G:\VERSIONCONTROL\GIT\DDD01\" // change this (this is the (GIT) directory where your files are saved)
 //
 ...
 //
 // STRING revisionInformationS[255] = Format( '"', "Last commit", ":", " ", GetDateStr(), " ", GetTimeStr(), '"' )
 ...
 //
 Message( FNFileSetUploadGithubFileVersionControlB( s1, s2, s3, s4, s5, s6, Val( s7 ), Val( s8 ) ) ) // gives e.g. TRUE if successful
END
