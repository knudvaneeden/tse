...
// library: program: run: version: control: github <description></description> <version control></version control> <version>1.0.0.0.2</version> <version control></version control> (filenamemacro=runprcgi.s) [<Program>] [<Research>] [kn, ri, su, 18-02-2018 07:18:27]
INTEGER PROC FNProgramRunVersionControlGithubB()
 ...
 //
 // B = StartPgm( urlS )
 PROCProgramRunInternetBrowserUrl( urlS )
 B = TRUE
 //
 RETURN( B )
 //
